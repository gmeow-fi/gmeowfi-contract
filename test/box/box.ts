...
describe("GMeowFiBox", function () {
  ...
  let xGM: TestToken,
    ...
    boxStorage: GMeowFiBoxStorageV1,
    entropy: GMeowFiEntropy,
    gMeowFiBox: GMeowFiBoxV1;
  ...
  before(async function () {
    ...
    boxStorage = await ethers.deployContract("GMeowFiBoxStorageV1", []);
    entropy = await ethers.deployContract("GMeowFiEntropy", [
      ethers.ZeroAddress,
      ethers.ZeroHash,
    ]);
    gMeowFiBox = await ethers.deployContract("GMeowFiBoxV1", [
